...
MOTOR_LEFT_TRIM: float = 70.0          # static offset for left motor [%]: positive = speed up left, negative = slow down left
...
SERVO_MIN_US: int = 700       # pulse width [µs] at 0°  (lowered from 800 – servo was sitting ~15° high at 0°)
